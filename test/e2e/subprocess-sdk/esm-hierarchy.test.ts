...
import { readReports, createTempStoreDir, SDK_IMPORT } from '../helpers/subprocess.js'
...
async function runMultiFile(
  ...
  const proc = Bun.spawn(
    ['bun', 'run', '-r', SUBPROCESS_PRELOAD, join(dir, entrypoint)],
    { cwd: PROJECT_ROOT, env: envVars as Record<string, string>, stdout: 'pipe', stderr: 'pipe' },
  )
