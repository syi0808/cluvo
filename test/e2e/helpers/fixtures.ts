...
export function createErrors() {
  ...
  return {
    simple, withCause, deepCause, typeError, customError,
    nonError: 'string error thrown' as unknown,
    nullError: null as unknown,
    withSensitive, circular,
  }
}
...
export const configs = {
  ...
  nonInteractiveSilent: { ...base, interactive: 'never' as const, nonInteractive: 'silent' as const },
