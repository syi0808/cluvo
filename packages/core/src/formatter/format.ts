import type { ErrorPayload, ErrorReport } from '../types.js'
import { DEFAULT_SECTIONS, SECTION_RENDERERS } from './sections.js'
...
export function formatBody(report: ErrorReport, options?: { sections?: string[] }): string {
